        ...
        // data-testid="kargo1"
         className="fs-5 py-5 text-lg">
            ...
            className="flex justify-between py-2">
                ...
                <span className="text-gray-700 font-semibold">{subTotal > 100 ? "Ücretsiz Kargo" : `${shipping}₺`}</span>
            </p>
            ...
            className="flex justify-between">
                ...
                <span className="text-gray-700 font-semibold text-2xl">{total}₺</span>
            </p>

            <button onClick={handleClick}
                className="bg-red-500 mt-4 w-full p-2 rounded-md text-white hover:bg-red-600 transition disabled:bg-red-300">Sipariş Ver</button>
